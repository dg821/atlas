...
protected:
    ...
    virtual Eigen::Vector3d computeTotalAcceleration(double t, SpaceVehicle& sv) const;
    virtual Eigen::Vector3d computePerturbAcceleration(double t, SpaceVehicle& sv) const;
    virtual Vector6d equationsOfMotion(double t, const Vector6d& stateVector, SpaceVehicle& sv) const;
